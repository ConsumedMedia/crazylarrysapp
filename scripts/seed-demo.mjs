...
const BOOKINGS = [
  ...
  { ref: 6, lifecycle: "active", size: "10yd", deliveryOffset: -2, rentalDays: 4, driver: "danielle",
  ...
  { ref: 14, lifecycle: "returned", size: "10yd", deliveryOffset: -15, pickupOffset: -9, driver: "danielle",
